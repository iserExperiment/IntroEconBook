...
class C(BaseConstants):
    ...
    #学生
    student = [STUDENT_1_ROLE, STUDENT_2_ROLE, STUDENT_3_ROLE, STUDENT_4_ROLE, STUDENT_5_ROLE, STUDENT_6_ROLE]
    #先生
    teacher = ['A', 'B', 'C', 'D', 'E', 'F']
    # 定員
    capacity_lim = {'A': 1,
    ...
    #研究室の学生に対する選好
    teacher_choices = {'A': ['student6', 'student5', 'student3', 'student2', 'student1', 'student4'],
    ...
    student_true_choices = {'student1': ['A', 'E', 'C', 'B', 'F', 'D'],
    ...
    #研究室の学生に対する選好(表示用)
    teacher_true_choices = {'A': ['6', '5', '3', '2', '1', '4'],
                       'B': ['1', '3', '4', '6', '2', '5'],
                       'C': ['6', '1', '2', '3', '5', '4'],
                       'D': ['1', '2', '6', '4', '3', '5'],
                       'E': ['2', '6', '1', '5', '4', '3'],
...
class Player(BasePlayer):
    ...
    student_fifth_choice = models.CharField(verbose_name='',
                                            choices=C.teacher,
                                            initial=None)

    student_sixth_choice = models.CharField(verbose_name='',
                                            choices=C.teacher,
                                            initial=None)
...
# FUNCTION------------------------------
def ia_algorithm(group, student_choices, totyu_studentStatus, totyu_teacherStatus,student_choices1,teiinflg):
        ...
        for s in C.student:
            if totyu_studentStatus[s] is None:  # 相手が決まっていない学生がいれば・・・
                ...
                elif len(totyu_teacherStatus[t]) == C.capacity_lim[t] and teiinflg[t] != "shime":  # 定員がいっぱいなら#ボストン用追加：定員が一杯フラグが違うのであれば
                ...
                if s == 'student6':
                    for t in C.teacher:
                        if len(totyu_teacherStatus[t]) == C.capacity_lim[t]:  # 定員が一杯なら、フラグを立てる
                            teiinflg[t] = "shime"
                        print(";;;;;;;;;;;;;;;;;;", teiinflg, s)
        if len([1 for y in totyu_studentStatus if totyu_studentStatus[y] is None]) != 0:
            ia_algorithm(group, student_choices, totyu_studentStatus, totyu_teacherStatus,student_choices1,teiinflg)
        else:
            # IAの結果を格納
...
def input_checks(group: Group):
    ...
    student_choices = {C.STUDENT_1_ROLE: [student1_part.student_first_choice, student1_part.student_second_choice,
                                          student1_part.student_third_choice, student1_part.student_fourth_choice,
                                          student1_part.student_fifth_choice, student1_part.student_sixth_choice],
                       C.STUDENT_2_ROLE: [student2_part.student_first_choice, student2_part.student_second_choice,
                                          student2_part.student_third_choice, student2_part.student_fourth_choice,
                                          student2_part.student_fifth_choice, student2_part.student_sixth_choice],
                       C.STUDENT_3_ROLE: [student3_part.student_first_choice, student3_part.student_second_choice,
                                          student3_part.student_third_choice, student3_part.student_fourth_choice,
                                          student3_part.student_fifth_choice, student3_part.student_sixth_choice],
                       C.STUDENT_4_ROLE: [student4_part.student_first_choice, student4_part.student_second_choice,
                                          student4_part.student_third_choice, student4_part.student_fourth_choice,
                                          student4_part.student_fifth_choice, student4_part.student_sixth_choice],
                       C.STUDENT_5_ROLE: [student5_part.student_first_choice, student5_part.student_second_choice,
                                          student5_part.student_third_choice, student5_part.student_fourth_choice,
                                          student5_part.student_fifth_choice, student5_part.student_sixth_choice],
                       C.STUDENT_6_ROLE: [student6_part.student_first_choice, student6_part.student_second_choice,
                                          student6_part.student_third_choice, student6_part.student_fourth_choice,
                                          student6_part.student_fifth_choice, student6_part.student_sixth_choice]
                       }
