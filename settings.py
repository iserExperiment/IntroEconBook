...
SESSION_CONFIGS = [
    ...
    dict(
       ...
       app_sequence=['b_input_id', 'ch8_comparative_advantage1_instruction', 'ch8_comparative_advantage1']
    ),
    dict(
       name='ch8_comparative_advantage2',
       display_name="第8章：比較優位（同じタイプ）",
       num_demo_participants=3,
       app_sequence=['b_input_id', 'ch8_comparative_advantage2_instruction', 'ch8_comparative_advantage2']
    ),
    dict(
       name='ch8_comparativeAdvantage3',
       display_name="第8章：比較優位（全員と取引可能）",
       num_demo_participants=3,
       app_sequence=['b_input_id', 'ch8_comparative_advantage3_instruction', 'ch8_comparative_advantage3']
    ),
    dict(
