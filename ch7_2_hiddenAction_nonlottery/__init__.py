...
class C(BaseConstants):
    NAME_IN_URL = 'ch7_2_hiddenAction_nonlottery'
    PLAYERS_PER_GROUP = 2
    NUM_ROUNDS = 3
    ...
    INSTRUCTIONS_TEMPLATE = 'ch7_2_hiddenAction_nonlottery/instruction.html'
...
page_sequence = [Introduction, Shuffle_Wait_Page, wait_confirmation,
page_1A, page_1B, result1, wait_confirmation,
page_2B, page_2A, result2, wait_confirmation, over]
